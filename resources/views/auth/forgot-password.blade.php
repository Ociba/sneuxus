...
<head>
        ...
        <title>Forgot Password :: Powered by Subrion 4.2</title>
...
<!--__e_-->
            ...
            <div class="mb-4 font-medium text-sm text-green-600">
                ...
                @endif
        <form method="POST" action="{{ route('password.email') }}" class="ia-form ia-form--bordered">
            @csrf
        <div class="fieldset">
...
<!--__e_-->
        ...
        <!-- SYSTEM STUFF -->
                ...
                <img src="../cron/index430c.html?921" width="1" height="1" alt="">
            </div>
