...
<head>
        ...
        <title>Members [I]  :: Powered by Subrion 4.2</title>
        ...
        <div class="container">
            <ol class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            ...
                            <a href="/members" rel="v:url" property="v:title">Members</a>
                                                                                ...
                                                                                <li typeof="v:Breadcrumb">
                            <a href="/I-index106" rel="v:url" property="v:title">Registered</a>
                        </li>
...
<!--__e_-->
    ...
    <li><a href="I-index713">All</a></li>

                        <li class="active"><a href="/I-index106" rel="nofollow">Registered</a></li>
            </ul>
    ...
    <div id="tab-all" class="tab-pane">
                        ...
                        <div id="tab-usergroups" class="tab-pane active">
                                    <ul class="nav nav-pills nav-pills-sm m-b">
                                        ...
                                        <li class="active"><a href="/I-index">I</a></li>
...
<!--__e_-->
        ...
        <!-- SYSTEM STUFF -->
                ...
                <img src="../../cron/index37f0.html?529" width="1" height="1" alt="">
            </div>
