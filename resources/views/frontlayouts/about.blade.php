<div id="block_landing_what_is_this"
         class="box section section-what" >
                    <div class="container">
                <h4 id="caption_landing_what_is_this" class="box__caption">What this all about?
                    </h4>
...
<!--__b_c_-->
    ...
    <div class="col-md-4">
        <img src="{{ asset('front/templates/kickstart/img/browser.png')}}" width="64" alt=""/>
    ...
    <div class="col-md-4">
        <img src="{{ asset('front/templates/kickstart/img/computer.png')}}" width="64" alt=""/>
    ...
    <div class="col-md-4">
        <img src="{{ asset('front/templates/kickstart/img/computer2.png')}}" width="64" alt=""/>
